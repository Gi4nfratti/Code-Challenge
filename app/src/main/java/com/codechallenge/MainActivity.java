...
public class MainActivity extends AppCompatActivity {
    private double DoorsArea = 1.52;
    private double WindowsArea = 2.40;
    ...
    public double h1,h2,h3,h4,w1,w2,w3,w4;
    ...
    public void calculateBtn(View view) {
        try {
            ...
            if (h1 < 1.0 || w1 < 1.0 || h2 < 1.0 || w2 < 1.0 || h3 < 1.0 || w3 < 1.0 || h4 < 1.0 || w4 < 1.0
